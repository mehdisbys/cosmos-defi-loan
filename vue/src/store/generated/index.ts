...
import MehdisbysLoanMehdisbysLoanLoan from './mehdisbys/loan/mehdisbys.loan.loan'
...
export default { 
  ...
  MehdisbysLoanMehdisbysLoanLoan: load(MehdisbysLoanMehdisbysLoanLoan, 'mehdisbys.loan.loan'),
